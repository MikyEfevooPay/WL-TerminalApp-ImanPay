...
import static com.ImanPay.demoui.utils.AlgorithmAES.generateIv;
import static com.ImanPay.demoui.utils.AlgorithmAES.generateKey;
                ...
                public void onResponse(String response) {
                    try {
                        ...
                        if(!object.has("mensaje")){
                            ...
                            TRACE.d("tpvConfigAmex: " +  TRACE.NEW_LINE + response.toString() );
